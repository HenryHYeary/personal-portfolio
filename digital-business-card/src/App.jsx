  ...
  <>
    <div id="main-component">
       ...
       <div id="description">
          ...
          <p className='paragraph'>I am a fullstack developer with over a thousand hours spent working in frontend and backend JS. I love learning
          ...
          <p className='paragraph'>Video game aficinado. Avid reader. Enjoyer of all genres of music and film. Coffee connosieur.</p>
       </div>
    </div>
    <div id="socials-bar">
